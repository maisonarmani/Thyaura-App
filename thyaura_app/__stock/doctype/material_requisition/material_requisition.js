...
frappe.ui.form.on('Material Requisition', {
    ...
    customer:function(frm){
        frappe.call({
            method: "thyaura_app.__stock.doctype.material_requisition.material_requisition.get_details",
    ...
    cur_frm.add_custom_button(__('Material Delivery Note'),
        function () {
            frappe.model.open_mapped_doc({
                method: "thyaura_app.__stock.doctype.material_requisition.material_requisition.make_delivery_note",
                frm: cur_frm
            });
        }
    );
